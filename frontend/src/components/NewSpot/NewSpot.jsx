...
export const NewSpot = () => {
    ...
    useEffect(() => {
        ...
        if (formInfo.description < 30) newErrors.description = 'Description needs 30 or more characters'; 
        ...
        <div className="create-spot-wrapper">
            ...
            >
                <div className="create-spot-heading">
                    ...
                    <p>
                        Guests will only get your address once they&apos;ve 
                ...
                <div className="line-break"></div>
                    <div className="form-title-container">
                        ...
                        <p>
                            Catch guest&apos; attention with a spot title that 
